    ...
    <header class="header navbar navbar-expand-sm expand-header">
      ...
      <ul class="navbar-item theme-brand flex-row text-center">
        <li class="nav-item theme-logo">
          <a href="index.html">
            <img
              src="{{asset('assets/dashboard')}}/src/assets/img/logo2.svg"
              class="navbar-logo"
              alt="logo"
            />
          </a>
      ...
      <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
        <li class="nav-item dropdown language-dropdown">
          ...
          >
            <img
              src="{{asset('assets/dashboard')}}/src/assets/img/1x1/us.svg"
              class="flag-width"
              alt="flag"
            />
          </a>
          ...
          >
            ...
            <a class="dropdown-item d-flex" href="javascript:void(0);"
              ><img
                src="{{asset('assets/dashboard')}}/src/assets/img/1x1/tr.svg"
                class="flag-width"
                alt="flag"
              />
            ...
            <a class="dropdown-item d-flex" href="javascript:void(0);"
              ><img
                src="{{asset('assets/dashboard')}}/src/assets/img/1x1/br.svg"
                class="flag-width"
                alt="flag"
              />
            ...
            <a class="dropdown-item d-flex" href="javascript:void(0);"
              ><img
                src="{{asset('assets/dashboard')}}/src/assets/img/1x1/in.svg"
                class="flag-width"
                alt="flag"
              />
            ...
            <a class="dropdown-item d-flex" href="javascript:void(0);"
              ><img
                src="{{asset('assets/dashboard')}}/src/assets/img/1x1/de.svg"
                class="flag-width"
                alt="flag"
              />
            ...
            <div class="notification-scroll">
              <div class="dropdown-item">
                <div class="media server-log">
                  <img
                    src="{{asset('assets/dashboard')}}/src/assets/img/profile-16.jpeg"
              ...
              <div class="dropdown-item">
                <div class="media">
                  <img
                    src="{{asset('assets/dashboard')}}/src/assets/img/profile-15.jpeg"
                    class="img-fluid me-2"
                    alt="avatar"
                  />
                  <div class="media-body">
              ...
              <div class="dropdown-item">
                <div class="media file-upload">
                  <img
                    src="{{asset('assets/dashboard')}}/src/assets/img/profile-21.jpeg"
                    class="img-fluid me-2"
                    alt="avatar"
                  />
                  <div class="media-body">
          ...
          >
            <div class="avatar-container">
              <div class="avatar avatar-sm avatar-indicators avatar-online">
                <img
                  alt="avatar"
                  src="{{asset('assets/dashboard')}}/src/assets/img/profile-30.png"
