@extends("layouts")
@section("title","Product Post - Classicads")
...
<!--=====================================
        ...
        <section class="adpost-part">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <form class="adpost-form" method="post" action="{{ route('dashboard.product.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" placeholder="Describe your message">{{ old('description') }}</textarea>
                            ...
                            <div class="adpost-card pb-2">
                                <div class="form-group text-right">
                                    <button class="btn btn-inline">
                                        ...
                                        <span>published your product</span>
                                    </button>
                                </div>
                            </div>
                        </form>
