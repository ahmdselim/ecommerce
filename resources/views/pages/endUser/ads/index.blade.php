...
<style>
    button.regularBtn.far.fa-heart::before {
        color: #000 !important;
    }

    button.clickedBtn.far.fa-heart::before {
                                ...
                                <div class="ad-feature-slider slider-arrow">
                                 ...
                                 <div class="feature-card">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <h3 class="feature-title"><a href="{{ route('endUser.ads.show',$ad->id) }}">{{ $ad->name }}</a></h3>
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-meta">
                                                <span><i class="fas fa-map-marker-alt"></i>{{ $ad->user->profiles[0]->city }}, {{ $ad->user->profiles[0]->country }}</span>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-btn">
                                                    ...
                                                    @foreach ($bookmarks as $key => $bookmark)
                                                        @if ($key === $ad->id && $bookmark === $ad->user_id)
                                                            <button type="button" title="Wishlist" class="clickedBtn far fa-heart"></button>
                                                        @else
                                                            <button type="button" title="Wishlist" class="regularBtn far fa-heart"></button>
                                                        @endif
                                                    @endforeach
                                                </div>
                                            </div>
