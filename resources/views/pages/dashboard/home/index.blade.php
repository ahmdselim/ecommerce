...
@section("dashboardHead" , "Dashboard | Home")
                  ...
                  <div class="account-box">
                    <div class="info-box">
                      <div class="icon">
                        <span>
                          <img
                            src="{{asset('assets/dashboard')}}/src/assets/img/money-bag.png"
                            alt="money-bag"
                          />
                        </span>
                      </div>
                  ...
                  <div class="meta-info">
                    ...
                    <div class="avatar--group">
                      ...
                      <div class="avatar translateY-axis">
                        <img
                          alt="avatar"
                          src="{{asset('assets/dashboard')}}/src/assets/img/profile-8.jpeg"
                        />
                      </div>
                      <div class="avatar translateY-axis">
                        <img
                          alt="avatar"
                          src="{{asset('assets/dashboard')}}/src/assets/img/profile-12.jpeg"
                        />
                      </div>
                      <div class="avatar translateY-axis">
                        <img
                          alt="avatar"
                          src="{{asset('assets/dashboard')}}/src/assets/img/profile-19.jpeg"
                        />
                      </div>
                    </div>
                  </div>
            ...
            >
              <div class="widget widget-card-two">
                <div class="widget-content">
                  <div class="media">
                    <div class="w-img">
                      <img src="{{asset('assets/dashboard')}}/src/assets/img/g-8.png" alt="avatar" />
                    </div>
                    <div class="media-body">
                  ...
                  <div class="card-bottom-section">
                    ...
                    <div class="img-group">
                      ...
                      />
                      <img
                        src="{{asset('assets/dashboard')}}/src/assets/img/profile-6.jpeg"
                        alt="avatar"
                      />
                      <img
                        src="{{asset('assets/dashboard')}}/src/assets/img/profile-8.jpeg"
                      ...
                      />
                      <img
                        src="{{asset('assets/dashboard')}}/src/assets/img/profile-3.jpeg"
                        alt="avatar"
                      />
                    </div>
...
<script src="{{asset('assets/dashboard')}}/src/plugins/src/apex/apexcharts.min.js"></script>
<script src="{{asset('assets/dashboard')}}/src/assets/js/dashboard/dash_1.js"></script>
<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
