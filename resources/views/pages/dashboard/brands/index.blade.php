...
@section("dashboardHead" , "Brands | Home")
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    <div class="avatar  me-3">
                                                        <img src="{{ $brand->image }}" alt="Avatar" width="64" height="64">
                                                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <span class="text-truncate fw-bold">{{ $brand->created_at }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                                        <a class="dropdown-item" href="{{ route('admin.brands.edit', $brand) }}">Edit</a>
