...
@section("dashboardHead" , "Department | Edit")
                    ...
                    <div class="widget-content widget-content-area p-3">
                        ...
                        <form method="post" action="{{route('admin.department.update' , $department)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control my-2" name="name_en" value="{{ $department->getTranslation('name', 'en') }}"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control my-2" name="name_ar" value="{{ $department->getTranslation('name', 'ar') }}""
