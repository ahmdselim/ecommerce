...
@section("dashboardHead" , "category | Edit")
                    ...
                    <div class="widget-content widget-content-area p-3">
                        ...
                        <form method="post" action="{{route('admin.category.update' , $category)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control my-2" name="name_en" value="{{ $category->getTranslation('name', 'en') }}"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control my-2" name="name_ar" value="{{ $category->getTranslation('name', 'ar') }}""
                                    placeholder="Name Of category In Arabic">
                                @error('name_ar')
                                <div class="alert alert-danger mt-1" role="alert">
